...
<body>
    ...
    <main class="mx-auto py-5 w-75 bg-white shadow">
        ...
        <div class="w-75 p-5 mx-auto d-flex justify-content-between align-items-center mainIndex">
            <img src="assets/images/natation.jpg"
                class="d-block object-fit-cover rounded-circle border border-4 border-info"
                alt="Course de natation vue du dessus.">

            <div class="ms-5 d-block text-center">
                <h5 class="card-title my-3">Natation</h5>
        ...
        <div class="w-75 p-5 mx-auto d-flex justify-content-between align-items-center mainIndex">
            <div class="me-5 d-block text-center">
            ...
            <img src="assets/images/athletisme.jpg"
                class="d-block object-fit-cover rounded-circle border border-4 border-danger"
        ...
        <div class="w-75 p-5 mx-auto d-flex justify-content-between align-items-center mainIndex">">
            ...
            <img src="assets/images/tennis.jpg"
                class="d-block object-fit-cover rounded-circle border border-4 border-success"
                alt="Une femme joue au tennis.">
        ...
        <div class="w-75 p-5 mx-auto d-flex justify-content-between align-items-center mainIndex">">
            ...
            <img src="assets/images/judo.jpg"
                class="d-block object-fit-cover rounded-circle border border-4 border-warning" alt="...">
        </div>

        <hr class="w-50 mx-auto">

        <div class="w-75 p-5 mx-auto d-flex justify-content-between align-items-center mainIndex">
            <img src="assets/images/escrime.jpg"
                class="d-block object-fit-cover rounded-circle border border-4 border-black"
                alt="Une femme joue au tennis.">
            <div class="ms-5 d-block text-center">
